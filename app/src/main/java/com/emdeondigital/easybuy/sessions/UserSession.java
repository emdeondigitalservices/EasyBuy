package com.emdeondigital.easybuy.sessions;
...
/**
 * Created by Nikhil on 04/21/2020.
 */
...
public class UserSession {
    ...
    public static final String KEY_ADDTOCART_PRODUCTS = "addtocartproducts";
    ...
    public Set<String> getWishListProducts(){
        return pref.getStringSet(KEY_WISHLIST_PRODUCTS,null);
    }
    ...
    public void setKeyWishlistProducts(Set<String> wishListProducts){
        editor.putStringSet(KEY_WISHLIST_PRODUCTS,wishListProducts);
        editor.commit();
    }

    public void setKeyAddToCartProducts(Set<String> addToCartProducts){
        editor.putStringSet(KEY_ADDTOCART_PRODUCTS,addToCartProducts);
        editor.commit();
    }

    public Set<String> getKeyAddToCartProducts(){
        return pref.getStringSet(KEY_ADDTOCART_PRODUCTS,null);
    }
}